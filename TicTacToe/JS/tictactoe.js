...
function checkWinConditions() {
    ...
    function arrayIncludes(squareA, squareB, squareC) {
        ...
        //true is returned and our else if confition executes the drawLine() function. 
...
function audio(audioURL) {
    //We create a new auido object and we pass the path as a parameter. 
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    let x1 = coordX1; 
        ...
        x = x1; 
        //This variable stores timporary y axis data we update in our animation loop. 
        y = y1
    ...
    animateLineDrawing(); 
    //This line waits 1 second. The, clears canvas, resets game, an allows clicking again. 
...
function resetGame() {
    ...
    for (let i = 0; i < 9; i++) {
        //This variazble gets the HTML element i. 
